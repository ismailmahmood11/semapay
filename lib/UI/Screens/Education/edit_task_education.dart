...
class EditTaskEducation extends StatelessWidget {
  EditTaskEducation({super.key});
                            ...
                            child: Row(
                              children: [
                                MainButton(
                                  ...
                                  width: 163,
                                  height: 111,
                                  child: Image.asset(psImage, fit: imageFit),
                                ),
                                MainButton(
                                  onTap: () => context
                                      .read<TaskCreationCubit>()
                                  ...
                                  width: 163,
                                  height: 111,
                                  child: Image.asset(xboxImage, fit: imageFit),
                                ),
                                MainButton(
                                  onTap: () => context
                                      .read<TaskCreationCubit>()
                                  ...
                                  height: 111,
                                  child:
                                      Image.asset(amazonImage, fit: imageFit),
                                ),
                              ],
                            ),
                          ),
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Gap(childGap),
                          MainDatePicker(state: state),
                          Gap(secondaryGap),
                          Text('Book (Grade 9)', style: titleStyle),
                          Gap(childGap),
                          Wrap(
                            children: [
                                  ...
                                  builder: (context, balance) {
                                    return MainBookCard(
                                      onTap: () {
                                        ...
                                        final taskCubit =
                                            context.read<TaskCreationCubit>();

                                        if (state.isEditing) {
                                          final oldAmount = taskCubit
                                              .state
                                              .tasks[state.taskIndexToEdit]
                                              .amount;
                                          final diff =
                                              updatedTask.amount - oldAmount;

                                          taskCubit.editTask(
                                              state.taskIndexToEdit,
                                              updatedTask);
